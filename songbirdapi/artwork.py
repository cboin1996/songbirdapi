...
def _fetch_and_store(itunes_url: str, thumb_path: str, full_path: str) -> tuple[str | None, str | None]:
...
async def fetch_and_store_artwork(song_uuid: str, itunes_url: str, artwork_dir: str) -> tuple[str | None, str | None]:
    ...
    return await loop.run_in_executor(None, _fetch_and_store, itunes_url, thumb_path, full_path)
